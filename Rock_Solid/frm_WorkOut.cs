...
namespace Rock_Solid
{
	public partial class frm_WorkOut : Form
	{
		...
		private void frm_WorkOut_Load(object sender, EventArgs e)
		{
			...
			#endregion
			#region Triceps
			cb_Pulley.Text = Triceps.TRICEPS_PULLEY;
			cb_RoscaTesta.Text = Triceps.TRICEPS_ROSCATESTA;
			cb_PulleyCorda.Text = Triceps.TRICEPS_PULLEYCORDA;
			cb_RoscaFrancesa.Text = Triceps.TRICEPS_ROSCAFRANCESA;
			cb_RoscaSupinada.Text = Triceps.TRICEPS_ROSCASUPINADA;
			cb_Coice.Text = Triceps.TRICEPS_COICE;
			cb_Invertido.Text = Triceps.TRICEPS_INVERTIDO;
			cb_Mergulho.Text = Triceps.TRICEPS_MERGULHO;

			nSerie_Pulley.Value = Triceps.TRICEPS_PULLEY_SERIE;
			nSerie_RoscaTesta.Value = Triceps.TRICEPS_ROSCATESTA_SERIE;
			nSerie_PulleyCorda.Value = Triceps.TRICEPS_PULLEYCORDA_SERIE;
			nSerie_RoscaFrancesa.Value = Triceps.TRICEPS_ROSCAFRANCESA_SERIE;
			nSerie_RoscaSupinada.Value = Triceps.TRICEPS_ROSCASUPINADA_SERIE;
			nSerie_Coice.Value = Triceps.TRICEPS_COICE_SERIE;
			nSerie_Invertido.Value = Triceps.TRICEPS_INVERTIDO_SERIE;
			nSerie_Mergulho.Value = Triceps.TRICEPS_MERGULHO_SERIE;

			nRep_Pulley.Value = Triceps.TRICEPS_PULLEY_REP;
			nRep_RoscaTesta.Value = Triceps.TRICEPS_ROSCATESTA_REP;
			nRep_PulleyCorda.Value = Triceps.TRICEPS_PULLEYCORDA_REP;
			nRep_RoscaFrancesa.Value = Triceps.TRICEPS_ROSCAFRANCESA_REP;
			nRep_RoscaSupinada.Value = Triceps.TRICEPS_ROSCASUPINADA_REP;
			nRep_Coice.Value = Triceps.TRICEPS_COICE_REP;
			nRep_Invertido.Value = Triceps.TRICEPS_INVERTIDO_REP;
			nRep_Mergulho.Value = Triceps.TRICEPS_MERGULHO_REP;

			nCarga_Pulley.Value = Triceps.TRICEPS_PULLEY_CARGA;
			nCarga_RoscaTesta.Value = Triceps.TRICEPS_ROSCATESTA_CARGA;
			nCarga_PulleyCorda.Value = Triceps.TRICEPS_PULLEYCORDA_CARGA;
			nCarga_RoscaFrancesa.Value = Triceps.TRICEPS_ROSCAFRANCESA_CARGA;
			nCarga_RoscaSupinada.Value = Triceps.TRICEPS_ROSCASUPINADA_CARGA;
			nCarga_Coice.Value = Triceps.TRICEPS_COICE_CARGA;
			nCarga_Invertido.Value = Triceps.TRICEPS_INVERTIDO_CARGA;
			nCarga_Mergulho.Value = Triceps.TRICEPS_MERGULHO_CARGA;
			#endregion
			#region WarmUp
			cb_Esteira.Text = WarmUp.WARMUP_ESTEIRA;
			cb_Bicicleta.Text = WarmUp.WARMUP_BICICLETA;
			cb_Eliptico.Text = WarmUp.WARMUP_ELIPTICO;
			cb_Corda.Text = WarmUp.WARMUP_CORDA;

			nSerie_Esteira.Value = WarmUp.WARMUP_ESTEIRA_SERIE;
			nSerie_Bicicleta.Value = WarmUp.WARMUP_BICICLETA_SERIE;
			nSerie_Eliptico.Value = WarmUp.WARMUP_ELIPTICO_SERIE;
			nSerie_Corda.Value = WarmUp.WARMUP_CORDA_SERIE;

			nRep_Esteira.Value = WarmUp.WARMUP_ESTEIRA_REP;
			nRep_Bicicleta.Value = WarmUp.WARMUP_BICICLETA_REP;
			nRep_Eliptico.Value = WarmUp.WARMUP_ELIPTICO_REP;
			nRep_Corda.Value = WarmUp.WARMUP_CORDA_REP;

			nCarga_Esteira.Value = WarmUp.WARMUP_ESTEIRA_CARGA;
			nCarga_Bicicleta.Value = WarmUp.WARMUP_BICICLETA_CARGA;
			nCarga_Eliptico.Value = WarmUp.WARMUP_ELIPTICO_CARGA;
			nCarga_Corda.Value = WarmUp.WARMUP_CORDA_CARGA;
			#endregion
		}
