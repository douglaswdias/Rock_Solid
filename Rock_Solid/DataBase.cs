		...
		public static void SelectWorkOut()
		{
			...
			cmd.CommandText = @"
					SELECT ABS_RETOABDOMEN, ABS_INFRA, ABS_OBLIQUO, ABS_PARALELAFIXA, ABS_PRANCHAABDOMEN, ABS_RETOABDOMEN_SERIE, ABS_INFRA_SERIE, 
						...
						SHOULDERS_DEVDUMBELL_CARGA, SHOULDERS_REMADAALTA_CARGA, TRICEPS_PULLEY, TRICEPS_ROSCATESTA, TRICEPS_PULLEYCORDA, TRICEPS_ROSCAFRANCESA, 
						TRICEPS_ROSCASUPINADA, TRICEPS_COICE, TRICEPS_INVERTIDO, TRICEPS_MERGULHO, TRICEPS_PULLEY_SERIE, TRICEPS_ROSCATESTA_SERIE, 
						TRICEPS_PULLEYCORDA_SERIE, TRICEPS_ROSCAFRANCESA_SERIE, TRICEPS_ROSCASUPINADA_SERIE, TRICEPS_COICE_SERIE, TRICEPS_INVERTIDO_SERIE, 
						TRICEPS_MERGULHO_SERIE, TRICEPS_PULLEY_REP, TRICEPS_ROSCATESTA_REP, TRICEPS_PULLEYCORDA_REP, TRICEPS_ROSCAFRANCESA_REP, 
						TRICEPS_ROSCASUPINADA_REP, TRICEPS_COICE_REP, TRICEPS_INVERTIDO_REP, TRICEPS_MERGULHO_REP, TRICEPS_PULLEY_CARGA, TRICEPS_ROSCATESTA_CARGA, 
						TRICEPS_PULLEYCORDA_CARGA, TRICEPS_ROSCAFRANCESA_CARGA, TRICEPS_ROSCASUPINADA_CARGA, TRICEPS_COICE_CARGA, TRICEPS_INVERTIDO_CARGA, 
						TRICEPS_MERGULHO_CARGA, WARMUP_ESTEIRA, WARMUP_BICICLETA, WARMUP_ELIPTICO, WARMUP_CORDA, WARMUP_ESTEIRA_SERIE, WARMUP_BICICLETA_SERIE, 
						WARMUP_ELIPTICO_SERIE, WARMUP_CORDA_SERIE, WARMUP_ESTEIRA_REP, WARMUP_BICICLETA_REP, WARMUP_ELIPTICO_REP, WARMUP_CORDA_REP, 
						WARMUP_ESTEIRA_CARGA, WARMUP_BICICLETA_CARGA, WARMUP_ELIPTICO_CARGA, WARMUP_CORDA_CARGA
					FROM WORKOUT 
			...
			while (reader.Read())
			{
				...
				#endregion
				#region Triceps
				Triceps.TRICEPS_PULLEY = reader.GetValue(200).ToString();
				Triceps.TRICEPS_ROSCATESTA = reader.GetValue(201).ToString();
				Triceps.TRICEPS_PULLEYCORDA = reader.GetValue(202).ToString();
				Triceps.TRICEPS_ROSCAFRANCESA = reader.GetValue(203).ToString();
				Triceps.TRICEPS_ROSCASUPINADA = reader.GetValue(204).ToString();
				Triceps.TRICEPS_COICE = reader.GetValue(205).ToString();
				Triceps.TRICEPS_INVERTIDO = reader.GetValue(206).ToString();
				Triceps.TRICEPS_MERGULHO = reader.GetValue(207).ToString();

				Triceps.TRICEPS_PULLEY_SERIE = Convert.ToInt32(reader.GetValue(208));
				Triceps.TRICEPS_ROSCATESTA_SERIE = Convert.ToInt32(reader.GetValue(209));
				Triceps.TRICEPS_PULLEYCORDA_SERIE = Convert.ToInt32(reader.GetValue(210));
				Triceps.TRICEPS_ROSCAFRANCESA_SERIE = Convert.ToInt32(reader.GetValue(211));
				Triceps.TRICEPS_ROSCASUPINADA_SERIE = Convert.ToInt32(reader.GetValue(212));
				Triceps.TRICEPS_COICE_SERIE = Convert.ToInt32(reader.GetValue(213));
				Triceps.TRICEPS_INVERTIDO_SERIE = Convert.ToInt32(reader.GetValue(214));
				Triceps.TRICEPS_MERGULHO_SERIE = Convert.ToInt32(reader.GetValue(215));

				Triceps.TRICEPS_PULLEY_REP = Convert.ToInt32(reader.GetValue(216));
				Triceps.TRICEPS_ROSCATESTA_REP = Convert.ToInt32(reader.GetValue(217));
				Triceps.TRICEPS_PULLEYCORDA_REP = Convert.ToInt32(reader.GetValue(218));
				Triceps.TRICEPS_ROSCAFRANCESA_REP = Convert.ToInt32(reader.GetValue(219));
				Triceps.TRICEPS_ROSCASUPINADA_REP = Convert.ToInt32(reader.GetValue(220));
				Triceps.TRICEPS_COICE_REP = Convert.ToInt32(reader.GetValue(221));
				Triceps.TRICEPS_INVERTIDO_REP = Convert.ToInt32(reader.GetValue(222));
				Triceps.TRICEPS_MERGULHO_REP = Convert.ToInt32(reader.GetValue(223));

				Triceps.TRICEPS_PULLEY_CARGA = Convert.ToInt32(reader.GetValue(224));
				Triceps.TRICEPS_ROSCATESTA_CARGA = Convert.ToInt32(reader.GetValue(225));
				Triceps.TRICEPS_PULLEYCORDA_CARGA = Convert.ToInt32(reader.GetValue(226));
				Triceps.TRICEPS_ROSCAFRANCESA_CARGA = Convert.ToInt32(reader.GetValue(227));
				Triceps.TRICEPS_ROSCASUPINADA_CARGA = Convert.ToInt32(reader.GetValue(228));
				Triceps.TRICEPS_COICE_CARGA = Convert.ToInt32(reader.GetValue(229));
				Triceps.TRICEPS_INVERTIDO_CARGA = Convert.ToInt32(reader.GetValue(230));
				Triceps.TRICEPS_MERGULHO_CARGA = Convert.ToInt32(reader.GetValue(231));
				#endregion
				#region WarmUp
				WarmUp.WARMUP_ESTEIRA = reader.GetValue(232).ToString();
				WarmUp.WARMUP_BICICLETA = reader.GetValue(233).ToString();
				WarmUp.WARMUP_ELIPTICO = reader.GetValue(234).ToString();
				WarmUp.WARMUP_CORDA = reader.GetValue(235).ToString();

				WarmUp.WARMUP_ESTEIRA_SERIE = Convert.ToInt32(reader.GetValue(236));
				WarmUp.WARMUP_BICICLETA_SERIE = Convert.ToInt32(reader.GetValue(237));
				WarmUp.WARMUP_ELIPTICO_SERIE = Convert.ToInt32(reader.GetValue(238));
				WarmUp.WARMUP_CORDA_SERIE = Convert.ToInt32(reader.GetValue(239));

				WarmUp.WARMUP_ESTEIRA_REP = Convert.ToInt32(reader.GetValue(240));
				WarmUp.WARMUP_BICICLETA_REP = Convert.ToInt32(reader.GetValue(241));
				WarmUp.WARMUP_ELIPTICO_REP = Convert.ToInt32(reader.GetValue(242));
				WarmUp.WARMUP_CORDA_REP = Convert.ToInt32(reader.GetValue(243));

				WarmUp.WARMUP_ESTEIRA_CARGA = Convert.ToInt32(reader.GetValue(244));
				WarmUp.WARMUP_BICICLETA_CARGA = Convert.ToInt32(reader.GetValue(245));
				WarmUp.WARMUP_ELIPTICO_CARGA = Convert.ToInt32(reader.GetValue(246));
				WarmUp.WARMUP_CORDA_CARGA = Convert.ToInt32(reader.GetValue(247));
				#endregion
			}
		}
		#endregion
